...
{
	private $controller_name_single = "Account";
	private $controller_name_plural = "Accounts";
	private $route_name = "account";
	private $model_name = "Accounts";
	...
	{		
		...
		// $rules = array(
		// 	'_token'				=> ['required'],
		// 	'book_id'				=> ['required', 'exists:accounts,id'],
	...
	public function update(Request $request, $id = 0)
	{
		...
		// $bookings_data = $this->AccountObj->getAccount(['id' => $request_data['update_id'], 'detail' => true]);
	...
	{
		// $this->AccountObj->deleteAccount($id);
	...
	public function payments_dealing(Request $request, $id = 0)
	{
		$request_data = $request->all();
