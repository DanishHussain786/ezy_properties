<fieldset>
  ...
  <div class="form-group col-md-4 col-sm-6">
    ...
    <input type="text" name="title" value="{{old('title', isset($data->title)? $data->title: '')}}"
      class="title form-control @error('title') is-invalid @enderror full_width" placeholder="Facility title or name">
    @error('title')
  ...
  <div class="form-group col-md-4 col-sm-6">
    ...
    <input type="text" name="description"
      ...
      placeholder="Facility description or information">
    @error('description')
    <span class="invalid-feedback" role="alert"> {{ $message }} </span>
    @else
    <span class="invalid-feedback" role="alert"></span>
  ...
  <div class="form-group col-md-4 col-sm-6">
    ...
    <input type="text" name="amount" id="amount" value="{{old('amount', isset($data->amount)? $data->amount: '')}}"
      ...
      placeholder="Amount/cost of facility" required>
    @error('amount')
    <span class="invalid-feedback" role="alert"> {{ $message }} </span>
    @else
    <span class="invalid-feedback" role="alert"></span>
...
<div class="col-md-12 form-group user-form-group">
  <div class="pull-right m-t-20">
    ...
    <button type="submit" class="btn btn-add btn-sm update_facility_submit">Update</button>
  </div>
</div>
