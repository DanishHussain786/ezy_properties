      ...
      @foreach ($data['records'] as $key => $item)
        ...
        <tr>
          ...
          <td>
            ...
            <button type="button" class="btn btn-danger btn-sm m-1 delete_btn" title="User Profile" data-delete_url="{{ url($data['route_name'].'/'.$item['id'])}}" data-toggle="modal" data-target="#del_user_popup"><i class="fa fa-trash-o"></i> </button>
          </td>
        </tr>
      @endforeach
    @endif
