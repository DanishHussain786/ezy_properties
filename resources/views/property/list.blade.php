    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header modal-header-primary">
          ...
          <h3 class="font-20"><i class="fa fa-user m-r-5"></i> Update Property Details</h3>
        </div>
  ...
  <div class="modal fade" id="del_property_popup" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header modal-header-primary">
          <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
          <h3 class="font-20"><i class="fa fa-user m-r-5"></i> Delete Property</h3>
        </div>
        <div class="modal-body">
          <div class="row">
            <div class="col-md-12">
  ...
  <div class="modal fade" id="reservation_popup" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header modal-header-primary">
          <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
          <h3 class="font-20"><i class="fa fa-user m-r-5"></i> Reservation Details</h3>
        </div>
        <div class="modal-body">
          <div class="row">
            <div class="col-md-12">
