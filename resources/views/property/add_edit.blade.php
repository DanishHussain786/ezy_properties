          ...
          <div class="panel-body">
            ...
            @csrf
              ...
              <div class="form-group dy_room_no col-md-4 col-sm-6 is-required" style="display: none;">
                ...
                <input type="number" name="room_no" id="room_no" value="{{old('room_no', isset($data->room_no)? $data->room_no: '')}}" class="form-control full_width @error('room_no') is-invalid @enderror" placeholder="Enter property room number" required>
                {{--@error('room_no')
                  <span class="invalid-feedback" role="alert"> {{ $message }} </span>
                @else
                  <span class="invalid-feedback" role="alert"></span>
              ...
              <div class="form-group dy_floor col-md-4 col-sm-6 is-required">
                ...
                <select class="select2_field form-control full_width @error('prop_floor') is-invalid @enderror" id="prop_floor" name="prop_floor" required>
                  <option value=""> ---- Choose any option ---- </option>
              ...
              <div class="form-group dy_rent col-md-4 col-sm-6 is-required">
                ...
                <input type="text" name="prop_rent" id="prop_rent" value="{{old('prop_rent', isset($data->prop_rent)? $data->prop_rent: '')}}" class="form-control full_width only_numbers @error('prop_rent') is-invalid @enderror" placeholder="Enter property rental cost" required>
                {{--@error('prop_rent')
                  <span class="invalid-feedback" role="alert"> {{ $message }} </span>
                @else
                  <span class="invalid-feedback" role="alert"></span>
              ...
              <div class="form-group dy_other_charges col-md-4 col-sm-6 is-required">
              ...
              <div class="form-group dy_dewa_ch col-md-4 col-sm-6 is-required">
                <label>DEWA Charges</label>
                <input type="text" name="dewa_ch" id="dewa_ch" value="{{old('dewa_ch', isset($data->dewa_ch)? $data->dewa_ch: '')}}" class="form-control full_width only_numbers @error('dewa_ch') is-invalid @enderror" placeholder="Enter dewa charges" required>
                {{--@error('dewa_ch')
                  <span class="invalid-feedback" role="alert"> {{ $message }} </span>
                @else
                  <span class="invalid-feedback" role="alert"></span>
              ...
              <div class="form-group dy_wifi_ch col-md-4 col-sm-6 is-required">
                <label>Wifi Charges</label>
                <input type="text" name="wifi_ch" id="wifi_ch" value="{{old('wifi_ch', isset($data->wifi_ch)? $data->wifi_ch: '')}}" class="form-control full_width only_numbers @error('wifi_ch') is-invalid @enderror" placeholder="Enter property rental cost" required>
                {{--@error('wifi_ch')
                  <span class="invalid-feedback" role="alert"> {{ $message }} </span>
                @else
                  <span class="invalid-feedback" role="alert"></span>
              ...
              <div class="form-group dy_misc_ch col-md-4 col-sm-6 is-required">
                <label>Misc. Charges</label>
                <input type="text" name="misc_ch" id="misc_ch" value="{{old('misc_ch', isset($data->misc_ch)? $data->misc_ch: '')}}" class="form-control full_width only_numbers @error('misc_ch') is-invalid @enderror" placeholder="Enter property rental cost" required>
                {{--@error('misc_ch')
                  <span class="invalid-feedback" role="alert"> {{ $message }} </span>
                @else
                  <span class="invalid-feedback" role="alert"></span>
              ...
              <div class="form-group dy_prop_add col-md-4 col-sm-6 is-required">
                ...
                <input type="text" name="prop_address" id="prop_address" value="{{old('prop_address', isset($data->prop_address)? $data->prop_address: '')}}" class="form-control full_width @error('prop_address') is-invalid @enderror" placeholder="Enter property address" required>
                {{--@error('prop_address')
                  <span class="invalid-feedback" role="alert"> {{ $message }} </span>
                @else
                  <span class="invalid-feedback" role="alert"></span>
