@php $title = 'List Services' @endphp
...
<section class="content">
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header modal-header-primary">
          ...
          <h3 class="font-20"><i class="fa fa-user m-r-5"></i> Add Service</h3>
        </div>
        <div class="modal-body">
          <div class="row">
            <div class="col-md-12">
              <form class="form-horizontal" id="manage-service" action="{{ url('service') }}" method="POST">
                {{-- @method('POST') --}}
                @csrf
                <fieldset>
        ...
        <div class="modal-footer">
          <div class="pull-right">
            <button type="button" id="add_service_btn" class="btn btn-add">Save</button>
  ...
  <!-- Modal -->
  <div class="modal fade" id="update_service_popup" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header modal-header-primary">
          <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
          <h3 class="font-20"><i class="fa fa-user m-r-5"></i> Update Service Details</h3>
        </div>
        <div class="modal-body">
          <div class="row">
            <div class="col-md-12">
              <form class="form-horizontal update_popup" id="upd_service" action="" method="POST">
                @method('PUT')
                @csrf
